...
const ListAkun = () => {
  ...
  const deleteAgree = async () => {
    await axios.delete(`http://localhost:5000/account/${uuid}`);
    setAlert(!alert);
    getData();
  };
        ...
        <table className={styles.tableWrap}>
          <thead>
            <tr>
              ...
              <th className={styles.tableTitle}>Username</th>
              <th className={styles.tableTitle}>Peran</th>
